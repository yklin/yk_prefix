...
multilib_src_configure() {
	...
	sed -i \
		-e 's/force_load" "/force_load /' \
		${WORKDIR}/${PN}/src/CMakeLists.txt || die
	sed -i \
		-e "s:\"c++abi\" \"c++abi\":\"c++abi\" \"${EPREFIX}/usr/lib/libc++abi.a\":" \
		${WORKDIR}/${PN}/cmake/Modules/HandleLibCXXABI.cmake || die
